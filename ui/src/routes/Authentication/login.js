      ...
      <div className="padding1">
        ...
        <form
          ...
          <div className="Fireapp-logo br3">
            ...
            <h2><strong>FIREAPP</strong></h2>
          </div>

          <div className="form-group-auth">
            <label htmlFor={'email'}><strong>Email or Username*:</strong></label>
            <input
          ...
          {/*</div>*/}
          <div className="new-to-fireapp silver"><strong>----------New to FireApp?----------</strong></div>
          <div id="register-btn" className={'submit-btn mt2 mb4'}>
            <a href="/register" className="btn w-80 bg-light-silver dim" role="button"><strong>Create an account</strong></a>
          </div>
          {error && (
